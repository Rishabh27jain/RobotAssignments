...
${CSS_GetVariableName}	    css:table.table-hover>tbody>tr:nth-child(${n})>td:nth-child(2)
...
${CSS_GetAnniversayName}	    css:table.table-hover>tbody>tr>td:first-child
${CSS_ClickAnniversayLogo}	    css:img[title='View all anniversaries']
${CSS_LogoutLink}		https://intranet.einfochips.com/employee_intranet/portal/auth/logout
